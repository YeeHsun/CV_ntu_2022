...
def build_vocabulary(image_paths, vocab_size):
    ...
    '''
    bag_of_words = []
    print("find the SIFT descriptors....")
    for path in image_paths:
        ...
        keypoints, descriptors = dsift(image, step=[3,3]) 
        
        if descriptors is not None:
            for des in descriptors:
                bag_of_words.append(des)
    print("find the vocabularies....")
    vocab = kmeans(np.array(bag_of_words).astype('float32'), vocab_size, initialization="PLUSPLUS")
