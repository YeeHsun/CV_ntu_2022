...
from cfg import efficient_cfg as cfg
#from cfg import ResNet_cfg as cfg
#from cfg import efficient1_cfg as cfg
#from cfg import efficient4_cfg as cfg
#from cfg import efficient7_cfg as cfg
...
def train_interface():
    ...
    #model = myResnet(in_channels=3, num_out=num_out)
